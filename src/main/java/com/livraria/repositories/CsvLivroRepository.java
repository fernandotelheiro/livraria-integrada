...
public class CsvLivroRepository {
    ...
    /** Busca por TÍTULO + AUTHOR (case-insensitive, trim ,e colapso de espacos). */
    public Optional<Livro> buscarPorTituloAutor(String titulo, String autor) {
